...
export default defineConfig(({ mode }) => {
  // Loads all env vars into process.env for server routes (never exposed to the client bundle).
  ...
  return {
    resolve: {
      alias: {
        // Pin entities to the hoisted v4.5.0 copy; nested v7 breaks React Email SSR.
