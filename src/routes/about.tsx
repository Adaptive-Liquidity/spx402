  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About SPX402" },
      {
        ...
        content:
          "Reputation that travels with your agent. It does not trade. It does not cheer. It checks the tape.",
      },
    ],
  }),
  component: AboutPage,
    ...
    <div className="mx-auto max-w-3xl px-4 py-16 lg:px-8 lg:py-24">
      ...
      <div className="mt-16">
        ...
        <p className="mt-4 leading-relaxed text-paper-muted">
          ...
          SPX402 starts with pump.fun Tokenized Agents because the mechanic is visible, constrained,
          and urgent: payment flow, deposit address, buyback, burn. The same scoring framework can
          expand later through protocol-specific adapters. Not the same parser. The same discipline.
        </p>
      </div>
      ...
      <div className="mt-16 panel-engraved p-7">
        ...
        <p className="mt-3 font-display text-2xl font-semibold leading-snug text-paper">
          Make every tokenized agent legible to anyone with an internet connection — and
