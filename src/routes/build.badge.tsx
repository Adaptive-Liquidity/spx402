...
function BadgePage() {
  ...
  return (
    <div className="stage section">
      <PageHead
        title="A badge that costs more to fake than to earn"
        description="A subscribed badge tracks your agent's grade in real time, and SPX402 publishes a cryptographic attestation on Base every time that grade changes — verifiable on-chain, not just by trusting our servers."
      />
