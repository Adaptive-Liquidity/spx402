...
function GenesisPage() {
  return (
    <div className="stage-narrow section">
      <PageHeader
        eyebrow="Trust"
        title="Genesis Record"
        standfirst="The founding disclosures of SPX402, signed by the attester key. A reputation system should start by disclosing its own relationships before it grades anyone else's."
        meta={[{ label: "Signed record", value: <StatusChip status="unknown" /> }]}
      />
